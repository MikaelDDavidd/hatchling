...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        "shortcut_createCheckpoint_desc": "Snapshot the project before the agent edits it",
        ...
        "mute_during_calls": "Mute while on a call",
        "mute_during_calls_desc": "Stay silent when the microphone is in use",
        "checkpoint_created": "Checkpoint saved",
        "checkpoint_failed": "Checkpoint failed",
        "shortcut_createCheckpoint": "Create git checkpoint",
        "question_feature": "Answer questions in the notch",
        "question_feature_desc": "Off: the CLI asks natively in your terminal",
        ...
        // Window
        "settings_title": "Hatchling Settings",
    ...
    private static let zh: [String: String] = [
        ...
        "shortcut_createCheckpoint_desc": "在智能体修改前为项目创建快照",
        ...
        "mute_during_calls": "通话时静音",
        "mute_during_calls_desc": "麦克风使用中时不播放提示音",
        "checkpoint_created": "检查点已保存",
        "checkpoint_failed": "检查点失败",
        "shortcut_createCheckpoint": "创建 Git 检查点",
        "question_feature": "在刘海中回答提问",
        "question_feature_desc": "关闭时由 CLI 在终端中原生询问",
        "interaction": "交互",
    ...
    private static let tr: [String: String] = [
        ...
        "shortcut_createCheckpoint_desc": "Ajan düzenlemeden önce projenin anlık görüntüsünü al",
        ...
        "mute_during_calls": "Görüşmedeyken sessize al",
        "mute_during_calls_desc": "Mikrofon kullanılırken sessiz kal",
        "checkpoint_created": "Kontrol noktası kaydedildi",
        "checkpoint_failed": "Kontrol noktası başarısız",
        "shortcut_createCheckpoint": "Git kontrol noktası oluştur",
        "question_feature": "Soruları çentikte yanıtla",
        "question_feature_desc": "Kapalıyken CLI terminalde doğrudan sorar",
    ...
    private static let pt: [String: String] = [
        ...
        "allow_horizontal_drag": "Permitir arrastar horizontalmente",
        "allow_horizontal_drag_desc": "Habilita arrastar o painel pra esquerda ou direita ao longo da barra de menu",
        "display": "Tela",
        "auto": "Auto",
        "builtin_display": "Tela integrada",
        "notch": "(Notch)",

        // Behavior
        "display_section": "Exibição",
        "hide_in_fullscreen": "Esconder em tela cheia",
        "hide_in_fullscreen_desc": "Oculta o painel automaticamente quando qualquer app entra em tela cheia",
        "hide_when_no_session": "Esconder quando não houver sessão ativa",
        "hide_when_no_session_desc": "Oculta o painel completamente quando nenhum agente está rodando",
        "smart_suppress": "Supressão inteligente",
        "smart_suppress_desc": "Não auto-expande quando o terminal do agente está em foco",
        "collapse_on_mouse_leave": "Recolher ao tirar o mouse",
        "collapse_on_mouse_leave_desc": "Recolhe o painel pro notch quando o mouse se afasta",
        "haptic_on_hover": "Feedback háptico ao passar o mouse",
        "haptic_on_hover_desc": "Dispara feedback háptico do trackpad ao passar o mouse pelo notch",
        "haptic_light": "Leve",
        "haptic_medium": "Médio",
        "haptic_strong": "Forte",
        "shortcuts": "Atalhos",
        "shortcut_recording": "Gravando…",
        "shortcut_none": "Sem atalho",
        "shortcut_togglePanel": "Alternar painel",
        "shortcut_togglePanel_desc": "Abre ou fecha o painel do Hatchling",
        "shortcut_approve": "Aprovar",
        "shortcut_approve_desc": "Aprova a solicitação de permissão atual",
        "shortcut_approveAlways": "Aprovar sempre",
        "shortcut_approveAlways_desc": "Aprova e lembra pra essa sessão",
        "shortcut_deny": "Negar",
        "shortcut_deny_desc": "Nega a solicitação de permissão atual",
        "shortcut_skipQuestion": "Pular pergunta",
        "shortcut_skipQuestion_desc": "Pula a pergunta atual",
        "shortcut_jumpToTerminal": "Ir pro terminal",
        "shortcut_jumpToTerminal_desc": "Vai pro terminal da sessão ativa",
        "shortcut_createCheckpoint_desc": "Tira um snapshot do projeto antes do agente mexer",
        "shortcut_conflict": "Conflita com",
        "sessions": "Sessões",
        "session_cleanup": "Limpeza de sessões ociosas",
        "session_cleanup_desc": "Remove automaticamente sessões sem atividade pelo tempo definido",
        "no_cleanup": "Nunca",
        "10_minutes": "10 minutos",
        "30_minutes": "30 minutos",
        "1_hour": "1 hora",
        "2_hours": "2 horas",
        "rotation_interval": "Intervalo de rotação de sessões",
        "rotation_interval_desc": "Frequência com que o notch alterna entre sessões ativas",
        "3_seconds": "3 segundos",
        "5_seconds": "5 segundos",
        "8_seconds": "8 segundos",
        "10_seconds": "10 segundos",
        "tool_history_limit": "Limite de histórico de ferramentas",
        "tool_history_limit_desc": "Quantidade máxima de chamadas recentes mostradas por sessão",

        // Appearance
        "preview": "Pré-visualização",
        "panel": "Painel",
        "max_visible_sessions": "Máximo de sessões visíveis",
        "max_visible_sessions_desc": "Sessões além desse limite ficam dentro de um scroll",
        "collapsed_width_scale": "Largura do notch",
        "collapsed_width_scale_desc": "Escala da largura do notch em telas sem notch real",
        "notch_height_mode": "Altura da barra superior",
        "notch_height_mode_desc": "Alinha o painel à altura real do notch, da barra de menu, ou um valor custom",
        "notch_height_match_notch": "Acompanhar altura do notch",
        "notch_height_match_menubar": "Acompanhar altura da barra de menu",
        "notch_height_custom": "Altura customizada",
        "custom_notch_height": "Altura customizada",
        "default": "Padrão",
        "content": "Conteúdo",
        "content_font_size": "Tamanho da fonte do conteúdo",
        "11pt_default": "11pt (padrão)",
        "ai_reply_lines": "Linhas da resposta da IA",
        "1_line_default": "1 linha (padrão)",
        "2_lines": "2 linhas",
        "3_lines": "3 linhas",
        "5_lines": "5 linhas",
        "unlimited": "Sem limite",
        "show_agent_details": "Mostrar detalhes da atividade do agente",
        "show_tool_status": "Detalhes da ferramenta na barra compacta",

        // Mascots
        "preview_status": "Status de preview",
        "processing": "Processando",
        "idle": "Ocioso",
        "waiting_approval": "Aguardando aprovação",
        "mascot_speed": "Velocidade da animação",
        "speed_off": "Desligada",
        "speed_slow": "0.5× lenta",
        "speed_normal": "1× normal",
        "speed_fast": "1.5× rápida",
        "speed_very_fast": "2× muito rápida",

        // Sound
        "enable_sound": "Ativar efeitos sonoros",
        "volume": "Volume",
        "session_start": "Início de sessão",
        "new_claude_session": "Nova sessão do Claude Code",
        "task_complete": "Tarefa concluída",
        "ai_completed_reply": "A IA terminou esta resposta",
        "task_error": "Erro na tarefa",
        "tool_or_api_error": "Falha de ferramenta ou erro da API",
        "system_section": "Sistema",
        "boot_sound": "Som de boot",
        "boot_sound_desc": "Toca um jingle quando o Hatchling inicia",
        "mute_during_calls": "Silenciar durante chamadas",
        "mute_during_calls_desc": "Fica em silêncio quando o microfone está em uso",
        "checkpoint_created": "Checkpoint salvo",
        "checkpoint_failed": "Falha no checkpoint",
        "shortcut_createCheckpoint": "Criar checkpoint no git",
        "question_feature": "Responder perguntas no notch",
        "question_feature_desc": "Desligado: o CLI pergunta direto no terminal",
        "interaction": "Interação",
        "approval_needed": "Aprovação necessária",
        "waiting_approval_desc": "Aguardando aprovação de permissão ou resposta",
        "task_confirmation": "Confirmação de tarefa",
        "you_sent_message": "Você enviou uma mensagem",
        "custom_sound": "Custom",
        "choose_sound_file": "Escolher arquivo de som",
        "reset_to_default": "Voltar pro padrão",
        "custom_sound_set": "Custom: %@",

        // Hooks
        "cli_status": "Status dos CLIs",
        "activated": "Ativo",
        ...
        "hooks_installed": "Hooks instalados com sucesso",
        "install_failed": "Falha na instalação",
        "hooks_uninstalled": "Hooks desinstalados",
        "remote_hosts": "Hosts remotos",
        "remote_hosts_empty": "Nenhum host remoto ainda. Adiciona um abaixo pra monitorar sessões via SSH.",
        "add_remote_host": "Adicionar host remoto",
        "remote_name": "Nome de exibição",
        "remote_host": "Host ou alias SSH",
        "remote_user": "Usuário SSH (opcional)",
        "remote_port": "Porta SSH (opcional)",
        "remote_identity": "Arquivo de identidade (opcional)",
        "remote_auto_connect": "Auto-conectar ao iniciar",
        "remote_add_button": "Adicionar host",
        "remote_hint": "O campo host pode ser um hostname normal ou um alias do seu ~/.ssh/config. O Hatchling instala um hook script remoto e encaminha eventos via SSH.",
        "remote_connect": "Conectar",
        "remote_connecting": "Conectando…",
        "remote_connected": "Conectado",
        "remote_disconnected": "Desconectado",
        "remote_disconnect": "Desconectar",
        "remote_remove": "Remover",

        // About
        "about_desc1": "Painel de status em tempo real pros agentes de IA do macOS",
        "about_desc2": "Suporta 17 ferramentas CLI/IDE via Unix socket IPC",

        // Window
        "settings_title": "Configurações do Hatchling",

        // Menu
        "settings_ellipsis": "Configurações...",
        "check_for_updates": "Buscar atualizações...",
        "export_diagnostics": "Exportar diagnóstico...",
        "export_diagnostics_desc": "Cria um zip com logs, settings e estado das sessões pra reportar bug",
        "reinstall_hooks": "Reinstalar hooks",
        "remove_hooks": "Remover hooks",
        "quit": "Sair",

        // Update
        "update_available_title": "Atualização disponível",
        "update_available_body": "Hatchling %@ disponível (atual: %@). Quer baixar?",
        "download_update": "Baixar",
        "later": "Depois",
        "no_update_title": "Tudo em dia",
        "no_update_body": "Hatchling %@ é a versão mais recente.",
        "ok": "OK",
        "update_now": "Atualizar agora",
        "update_downloading": "Baixando atualização...",
        "update_failed_title": "Atualização falhou",
        "update_failed_body": "Não foi possível instalar a atualização: %@",
        "update_manual_download": "Baixar manualmente",
        "update_installing": "Instalando atualização...",
        "update_retry": "Tentar de novo",
        "update_homebrew_title": "Atualização disponível",
        "update_homebrew_body": "Hatchling %@ disponível. Como você instalou via Homebrew, roda:",
        "update_homebrew_command": "brew upgrade hatchling",
        "update_copy_command": "Copiar comando",

        // NotchPanel
        "mute": "Mudo",
        "enable_sound_tooltip": "Ativar som",
        ...
        "submit": "ENVIAR",
        "open_path": "Abrir",
        "copy_session_id": "Copiar ID da sessão",
        ...
        "other": "Outros",
        "n_sessions": "sessões",
        "scroll_for_more": "Role pra ver mais",
        "scroll_hidden": "abaixo",
        "lines": "linhas",
    ]
}
